...
def main(args):
    ...
    if not parse_out:
        sys.stderr.write(" Unable to create h264 parse out")
    ...
    # caps -> encoder -> h264parse -> mpegtsmux -> udpsink
    ...
    print("\n *** DeepStream: UDP MPEG-TS at udp://127.0.0.1:%d ***\n" % updsink_port_num)
    try:
    ...
    ff_cmd = [
        ...
        "-i", f"udp://127.0.0.1:{updsink_port_num}",
